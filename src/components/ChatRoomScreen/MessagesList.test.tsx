...
describe('MessagesList', () => {
  ...
  test('renders messages data', () => {
    ...
    expect(getByTestId(message1, 'message-date')).toHaveTextContent('18:00')
    expect(getByTestId(message2, 'message-content')).toHaveTextContent('bar')
    expect(getByTestId(message2, 'message-date')).toHaveTextContent('18:00')
  })
})
